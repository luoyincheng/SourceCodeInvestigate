...
/**
 * Created by yincheng on 2018/5/9/15:04.
 * github:luoyincheng
 */
public final class MessageQueue {
    ...
    /**
     * Add a new {@link MessageQueue.IdleHandler} to this message queue.  This may be
     * removed automatically for you by returning false from
     * {@link MessageQueue.IdleHandler#queueIdle IdleHandler.queueIdle()} when it is
    ...
    /**
     * Remove an {@link MessageQueue.IdleHandler} from the queue that was previously added
     ...
     * {@link MessageQueue.OnFileDescriptorEventListener#EVENT_INPUT},
     * {@link MessageQueue.OnFileDescriptorEventListener#EVENT_OUTPUT}, and
     * {@link MessageQueue.OnFileDescriptorEventListener#EVENT_ERROR} event masks.  If the requested
     * set of events is zero, then the listener is unregistered.
     * @param listener The listener to invoke when file descriptor events occur.
     *
     * @see MessageQueue.OnFileDescriptorEventListener
     * @see #removeOnFileDescriptorEventListener
     */
    public void addOnFileDescriptorEventListener(@NonNull FileDescriptor fd,
                                                 @MessageQueue.OnFileDescriptorEventListener.Events int events,
                                                 @NonNull MessageQueue.OnFileDescriptorEventListener listener) {
        if (fd == null) {
    ...
    private void updateOnFileDescriptorEventListenerLocked(FileDescriptor fd, int events,
        ...
        if (events != 0) {
            events |= MessageQueue.OnFileDescriptorEventListener.EVENT_ERROR;
            if (record == null) {
                if (mFileDescriptorRecords == null) {
    ...
    private int dispatchEvents(int fd, int events) {
        ...
        final MessageQueue.OnFileDescriptorEventListener listener;
        final int seq;
        synchronized (this) {
        ...
        if (newWatchedEvents != 0) {
            newWatchedEvents |= MessageQueue.OnFileDescriptorEventListener.EVENT_ERROR;
        }
    ...
    private static final class FileDescriptorRecord {
        ...
        public FileDescriptorRecord(FileDescriptor descriptor,
                                    int events, MessageQueue.OnFileDescriptorEventListener listener) {
