...
public class MemoryLruCache<K, V> {
    ...
    private int evictionCount;//删除的Entry数量
    private int hitCount;
    private int missCount;

    /**
     * @param maxSize for caches that do not override {@link #sizeOf},这是缓存里面可以存放的最大entry数量. For all other caches,
    ...
    public void resize(int maxSize) {
        ...
        //如果当前的maxSize小于之前的maxSize，意味着最少使用的那些entry需要被丢弃掉
        trimToSize(maxSize);
    }
