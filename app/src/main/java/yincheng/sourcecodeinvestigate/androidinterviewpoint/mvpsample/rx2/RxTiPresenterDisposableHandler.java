...
package yincheng.sourcecodeinvestigate.androidinterviewpoint.mvpsample.rx2;

import android.support.annotation.NonNull;
import io.reactivex.disposables.CompositeDisposable;
import io.reactivex.disposables.Disposable;
import yincheng.sourcecodeinvestigate.androidinterviewpoint.mvp.TiLifecycleObserver;
...
public class RxTiPresenterDisposableHandler {
     ...
     *
     * @throws IllegalStateException when the presenter has reached {@link TiPresenter.State#DESTROYED}
     */
