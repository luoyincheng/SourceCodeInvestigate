...
import static yincheng.sourcecodeinvestigate.androidinterviewpoint.mvpsample.fragmentlifecycle
      .FragmentLifecycleActivity.fragmentLifecycleActivityInstanceCount;
...
public abstract class TestFragment
    ...
    public void onDetach() {
        ...
        mAddedState.onComplete();
        mDetachedState.onComplete();
        mRemovingState.onComplete();
        mIsActivityChangingConfigState.onComplete();
        mIsActivityFinishingState.onComplete();
    }
