 ...
 * {@link TiConfiguration.Builder#setRetainPresenterEnabled(boolean)}
 ...
 * <p>
 * {@link TiActivity} is able to detect when its presenter should be
 * destroyed and tells this savior when to free a presenter instance.
 * </p>
 * <p>
 * {@link TiFragment} can't detect on its own when its hosting Activity
