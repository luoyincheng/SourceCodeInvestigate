...
import yincheng.sourcecodeinvestigate.androidinterviewpoint.mvvm.model.User;

/**
 * Created by yincheng on 2018/5/22/16:49.
 * github:luoyincheng
 */
public class RepositoriesViewModel implements ViewModel {
   ...
   public RepositoriesViewModel(Context context, final Repository repository) {
   ...
   private void loadFullUser(String url) {
      ...
      disposable = githubService.getUserFromUrl(url)
