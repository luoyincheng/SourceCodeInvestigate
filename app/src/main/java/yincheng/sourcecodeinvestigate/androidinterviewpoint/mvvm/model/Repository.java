...
/**
 * Created by yincheng on 2018/5/22/14:32.
 * github:luoyincheng
 */
public class Repository implements Parcelable {
    ...
    public int forks;
    public int watchers;
    @SerializedName("stargazers_count") public int stars;
    ...
    public static final Parcelable.Creator<Repository> CREATOR = new Parcelable
            .Creator<Repository>() {
